...
:root {
  ...
  --cc-bg: #${theme.current.base1};
  --noti-border-color: #${theme.current.accent};
  --noti-bg: 48, 48, 48;
  --noti-bg-alpha: 0.9;
  --noti-bg-darker: #${theme.current.base2};
  --noti-bg-hover: #${theme.current.base1};
  --noti-bg-focus: #${theme.current.surface0};
  --noti-close-bg: #${theme.current.surface1};
  --noti-close-bg-hover: #${theme.current.surface2};
  --text-color: #${theme.current.text1};
  --text-color-disabled: #${theme.current.text3};
  --bg-selected: #${theme.current.blue};
